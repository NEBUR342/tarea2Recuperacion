...
use Src\Usuario;
if (isset($_POST['cancelar']) || !isset($_SESSION['id']) || $_GET['id']!=$_SESSION['id']) {
...
if (isset($_POST['editar'])) {
    ...
    } else if(Usuario::existeEmail($email,$id)){
        $errores = true;
...
?>
    ...
    <body style="background-color:darkgray">
        <div class="container">
            <form name="crear" action="<?php echo $_SERVER['PHP_SELF']."?id=$id" ?>" method="POST">
                <h5 class="text-center my-4">Editar usuario</h5>
                <div class="mb-3">
                    <label for="nombreUsuario" class="form-label">Nombre</label>
                    <input type="text" class="form-control" id="nombreUsuario" name="nombre" <?php echo "value='$usuario->nombre'"; ?>>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="apellidosUsuario" name="apellidos" <?php echo "value='$usuario->apellidos'"; ?>>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="emailUsuario" name="email" <?php echo "value='$usuario->email'"; ?>>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="sueldoUsuario" name="sueldo" <?php echo "value='$usuario->sueldo'"; ?>>
                    <?php
                ...
                <label for="sueldoUsuario" class="form-label">Permisos</label>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="permisos" id="flexRadioDefault2" value="NO"  <?php if($usuario->is_admin=="NO") echo "checked"; ?>>
                        <label class="form-check-label" for="flexRadioDefault2">
                            Usuario
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="permisos" id="flexRadioDefault1" value="SI" <?php if($usuario->is_admin=="SI") echo "checked"; ?>>
                ...
                <div class="float-end">
                    <button class="btn btn-outline-success btn-lg px-4" type="submit" name="editar"><i class="fa-solid fa-floppy-disk"> Editar</i></button>
